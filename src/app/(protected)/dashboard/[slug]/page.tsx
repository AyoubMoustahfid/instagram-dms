...
import { DASHBOARD_CARDS } from '@/constans/dashboard'
import { BarDuoTone } from '@/icons/gloabl-icons'
...
const Page = (props: Props) => {
    return (
        <div className="flex flex-col gap-y-10 overflow-y-scroll no-scrollbar">
