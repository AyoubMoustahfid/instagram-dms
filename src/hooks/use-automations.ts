...
import {z} from "zod"
import useZonForm from "./use-zon-form"
import { AppDisplatch, useAppSelector } from "@/redux/store"
...
export const useListener = (id: string) => {
    ...
    const {errors, onFormSubmit, register, reset, watch} = useZonForm(
        promptSchema, 
        mutate
    )
...
export const useTriggers = (id: string) => {
    ...
    const dispatch: AppDisplatch = useDispatch()
...
export const useKeywords = (id: string) => {
    ...
    const onVolumeChange = (e: React.ChangeEvent<HTMLInputElement>) => setKeyword(e.target.value)
    ...
    return { keyword, onVolumeChange, onKeyPress, deleteMutation }
}
